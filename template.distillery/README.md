...
Note that external dependencies are required prior to building the project,
namely, Postgres which is mandatory and SASS, Postcss and autoprefixer which
are not but are recommended as they will improve the rendering of the pages
generated.
