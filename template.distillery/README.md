...
project.  Postgres is mandatory. NPM is also mandatory for
automatically installing various NPM packages. SASS is optional, but
not installing it may negatively impact the rendering of the pages
generated. All of these packages can be installed via the command
